...
public class [Table2]Controller {
	...
	public [Table2] findOne(@PathVariable String id){
	...
	public PageResult<[Table2]> findPage(@PathVariable int page,@PathVariable int size){		
		Page<[Table2]> pageList = [table2]Service.findPage(page, size);		
		return new PageResult<[Table2]>(pageList.getTotalElements(), pageList.getContent());		
	}
	...
	public PageResult<[Table2]> findSearch(@RequestBody Map searchMap ,@PathVariable int page,@PathVariable int size){		
